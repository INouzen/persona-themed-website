...
const ITEMS = [
  { id: "i", badge: "I", title: "EDUCATION", subtitle: "Information Technology", rank: 1 },
  { id: "ii", badge: "II", title: "SKILLS", subtitle: "Java / JavaScript / CSS / HTML", rank: 2 },
  { id: "iii", badge: "III", title: "PROJECTS", subtitle: "Web App / Roblox Game / Cloning", rank: 3 },
  { id: "iv", badge: "IV", title: "FOCUS", subtitle: "Frontend", rank: 4 },
];
  ...
  return (
    <div id="menu-screen">
      ...
      <style>{`
        ...
        .resume-card-wrap.active .resume-card::before {
          background: #ffffff;
       ...
       /* THE OUTER LAYER (White Border) */
        .resume-badge {
          ...
          width: 62px;
          height: 76px;
          background: #ffffff; /* This is your P5-style thick white border */
          /* Slightly more aggressive angles for the P5 look */
        ...
        /* THE INNER LAYER (Black Fill) */
        .resume-badge-inner {
          position: absolute;
          /* The 'inset' creates the border thickness (adjust to your taste) */
          inset: 4px; 
          background: #0d0d0d;
          clip-path: polygon(10% 0, 100% 0, 90% 100%, 0 100%);
          display: flex;
        ...
        .resume-badge-text {
          ...
          color: #ffffff;
          letter-spacing: 1px;
          /* Counter-rotate keeps the text upright while the box is slanted */
          transform: rotate(8deg); 
          text-align: center;
          width: 100%;
          display: block;
          ...
          {ITEMS.map((item, index) => (
            ...
            >
              <div className="resume-card">
                {/* FIX: The badge now consists of an outer white box and an inner black box.
                  Since both are clipped the same way, the white outer box appears as a 
                  perfectly straight 3px border that won't "shred" or "split."
                */}
          ...
          <div className="resume-detail-panel">
            ...
            <div className="resume-detail-bottom">
              ...
              <div className="resume-detail-bullets">
                <div className="resume-detail-bullet">- Pursuing BS in IT at AMA Computer College Fairview.</div>
                <div className="resume-detail-bullet">- STEM curriculum background at Mater Carmeli School.</div>
              </div>
            </div>
          </div>
        )}
