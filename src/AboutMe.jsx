...
const REVEAL_CONTENT = [
  {
    upper: ["name: Nouzen", "age: 20 years ", "location: Philippines"],
    lower: "2nd Year BSIT Student",
  },
  {
    upper: [
  ...
  },
  {
    ...
    lower: "github: https://github.com/INouzen",
  },
];

const ITEMS = [
  {
    id: "about", label: "ABOUT ME", handle: "@INouzen", href: "https://github.com/INouzen", icon: "👤", barIcon: icon1, bars: 1, newBars: [0], counts: ["20"],
    links: ["github.com/INouzen"],
    stats: [
      { tag: "AGE", value: "20", color: "#d92323" },
      { tag: "YEAR", value: "2nd BSIT",  color: "#7b7b7b" },
    ],
  },
  {
    id: "fun", label: "EDUCATION", handle: "@nouzen", href: "https://github.com/INouzen", icon: "🏫", barIcon: icon2, bars: 2, newBars: [0, 1], counts: ["IFPB", "TECH"],
  ...
  {
    id: "weird", label: "LANGUAGES", handle: "@nouzen", href: "https://github.com/INouzen", icon: "💻", barIcon: icon3, bars: 3, newBars: [0, 1, 2], counts: ["JAVA", "JS", "WEB"],
